...
func init() {
	...
	calcMem("NikandMux", func() {
		parseNikandMux = loadNikandMux(parseAPI)
	})
	calcMem("Pat", func() {
...
func BenchmarkNikandMux_ParseStatic(b *testing.B) {
	req, _ := http.NewRequest("GET", "/1/users", nil)
	benchRequest(b, parseNikandMux, req)
}
...
func BenchmarkNikandMux_ParseParam(b *testing.B) {
	req, _ := http.NewRequest("GET", "/1/classes/go", nil)
	benchRequest(b, parseNikandMux, req)
}
...
func BenchmarkNikandMux_Parse2Params(b *testing.B) {
	req, _ := http.NewRequest("GET", "/1/classes/go/123456789", nil)
	benchRequest(b, parseNikandMux, req)
}
...
func BenchmarkNikandMux_ParseAll(b *testing.B) {
	benchRoutes(b, parseNikandMux, parseAPI)
}
